...
def encode_words(words):
    ...
    vocabulario = {palavra: indice for indice, palavra in enumerate(set(tokens))}
    comentario_numerico = [vocabulario[token] for token in tokens]
    return comentario_numerico
    ...
    for opnion in opnions:
        ...
        atualizacao = {
            "$set": {
                ...
                "classification": "Positiva" if opnion.predict >= 60 else "Negativa",
            }
        }
